...
public class ScholarStaffGhost : ModNPC
{
    ...
    public override void AI()
    {
        ...
        {
            PixelEmber particle = PixelEmber.RequestNew(NPC.Center + Main.rand.NextVector2Circular(20, 30), Main.rand.NextVector2Circular(4, 3), Main.rand.Next(400, 750), 150, Color.Cyan with { A = 0 }, ScholarStaffBolt.EnergyColor with { A = 0 }, 0.5f + Main.rand.NextFloat());
