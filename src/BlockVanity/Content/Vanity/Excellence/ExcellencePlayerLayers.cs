...
{
    public static LazyAsset<Texture2D> HeadGlowTexture { get; } = new LazyAsset<Texture2D>($"{nameof(BlockVanity)}/Assets/Textures/Vanity/Excellence/Excellence_{EquipType.Head}_Glow");
