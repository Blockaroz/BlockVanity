...
public class FrostbuiltKingHeadGlowLayer : PlayerDrawLayer
{
    public override Position GetDefaultPosition() => new AfterParent(PlayerDrawLayers.Head);

    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) => drawInfo.drawPlayer.head == EquipLoader.GetEquipSlot(Mod, nameof(FrostbuiltKingSkull), EquipType.Head);
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        ...
        DrawData glowData = new DrawData(FrostbuiltKingSkull.glowTextureArmor.Value, pos, drawInfo.drawPlayer.bodyFrame, drawColor, drawInfo.drawPlayer.headRotation, drawInfo.headVect, 1f, drawInfo.playerEffect, 0);
        glowData.shader = drawInfo.cHead;
        drawInfo.DrawDataCache.Add(glowData);
    }
}

public class FrostbuiltKingBodyGlowLayer : PlayerDrawLayer
{
    public override Position GetDefaultPosition() => new AfterParent(PlayerDrawLayers.Torso);

    public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) => drawInfo.drawPlayer.body == EquipLoader.GetEquipSlot(Mod, nameof(FrostbuiltKingGarb), EquipType.Body);

    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        Texture2D glowTexture = FrostbuiltKingGarb.glowTextureArmor.Value;
...
public class FrostbuiltKingArmOnGlowLayer : PlayerDrawLayer
{
...
public class FrostbuiltKingArmOffGlowLayer : PlayerDrawLayer
{
